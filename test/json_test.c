...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 0) && (intVal == 0));
//     nats_JSONDestroy(json);
//     json = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (strcmp(strVal, "abc") == 0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(strVal);
//     strVal = NULL;
...
//     IFOK(s, nats_JSONGetStr(json, "test", &strVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (strcmp(strVal, "\"\\/\b\f\n\r\t") == 0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(strVal);
//     strVal = NULL;
...
//     IFOK(s, nats_JSONGetStr(json, "test", &strVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (strcmp(strVal, "&<>") == 0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(strVal);
//     strVal = NULL;
...
//     IFOK(s, nats_JSONGetInt(json, "test", &intVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (intVal == 1234));
//     nats_JSONDestroy(json);
//     json = NULL;
//     intVal = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (int32Val == 1234));
//     nats_JSONDestroy(json);
//     json = NULL;
//     int32Val = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (uint16Val == 1234));
//     nats_JSONDestroy(json);
//     json = NULL;
//     uint16Val = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (longVal == 9223372036854775807L));
//     nats_JSONDestroy(json);
//     json = NULL;
//     longVal = 0;
...
//     IFOK(s, nats_JSONGetLong(json, "test", &longVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (longVal == (int64_t)0x8000000000000000));
//     nats_JSONDestroy(json);
//     json = NULL;
//     longVal = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (ulongVal == 0xFFFFFFFFF8A432EB));
//     nats_JSONDestroy(json);
//     json = NULL;
//     ulongVal = 0;
...
//     IFOK(s, nats_JSONGetULong(json, "test", &ulongVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (ulongVal == 0xFFFFFFFFFFFFFFFF));
//     nats_JSONDestroy(json);
//     json = NULL;
//     ulongVal = 0;
...
//     IFOK(s, nats_JSONGetULong(json, "test", &ulongVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (ulongVal == 9007199254740993));
//     nats_JSONDestroy(json);
//     json = NULL;
//     ulongVal = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)1234.5e+3));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     s = nats_JSONParse(&json, "{\"test\":-1234}", -1);
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)-1234));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)1234.0 / 1000.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345.0 / 10000.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345.0 / 100.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345.0 / 10.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     s = nats_JSONParse(&json, "{\"test\":1234e+3}", -1);
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)1234.0 * 1000));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345678.0 / 100.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345678.0 / 10000.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345678.0 * 10.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     IFOK(s, nats_JSONGetDouble(json, "test", &doubleVal));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (doubleVal == (long double)12345678.0 / 1000.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     doubleVal = 0;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && boolVal);
//     nats_JSONDestroy(json);
//     json = NULL;
//     boolVal = false;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 3) && arrBoolVal[0] && !arrBoolVal[1] && arrBoolVal[2]);
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrBoolVal);
//     arrBoolVal = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 3) && (arrDoubleVal[0] == 1.0) && (arrDoubleVal[1] == 2.0) && (arrDoubleVal[2] == 3.0));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrDoubleVal);
//     arrDoubleVal = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 3) && (arrIntVal[0] == 1) && (arrIntVal[1] == 2) && (arrIntVal[2] == 3));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrIntVal);
//     arrIntVal = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 3) && (arrLongVal[0] == 1) && (arrLongVal[1] == 2) && (arrLongVal[2] == 3));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrLongVal);
//     arrLongVal = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 3) && (arrULongVal[0] == 1) && (arrULongVal[1] == 2) && (arrULongVal[2] == 3));
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrULongVal);
//     arrULongVal = NULL;
...
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrCount == 2) && (nats_JSONGetInt(arrObjVal[0], "a", &intVal) == NATS_OK) && (intVal == 1) && (nats_JSONGetBool(arrObjVal[1], "b", &boolVal) == NATS_OK) && boolVal);
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(arrObjVal);
//     arrObjVal = NULL;
...
//     s = nats_JSONParse(&json, "{\"test\":null}", -1);
//     IFOK(s, nats_JSONGetArrayObject(json, "test", &arrObjVal, &arrCount));
//     testCond((s == NATS_OK) && (json != NULL) && (json->fields != NULL) && (json->fields->used == 1) && (arrObjVal == NULL) && (arrCount == 0));
//     nats_JSONDestroy(json);
//     json = NULL;
...
//     testCond((s == NATS_OK) && (intVal == 1) && boolVal && (doubleVal == (long double)12.0 / 10.0) && (longVal == 3));
//     nats_JSONDestroy(json);
//     json = NULL;
//     intVal = 0;
//     boolVal = false;
...
//             IFOK(s, nats_JSONGetTime(json, "time", &longVal));
//             testCond((s == NATS_OK) && (json != NULL) && (longVal == results[i]));
//             nats_JSONDestroy(json);
//             json = NULL;
//         }
//     }
...
//     IFOK(s, nats_JSONGetBytes(json, "test", &bytes, &bl));
//     testCond((s == NATS_OK) && (bytes != NULL) && (bl == 31) && (strncmp((const char *)bytes, "this is testing base64 encoding", bl) == 0));
//     nats_clearLastError();
//     nats_JSONDestroy(json);
//     json = NULL;
//     free(bytes);
