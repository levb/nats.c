 ...
 *
 * \warning To use this API compile the client code with
 * `-DNATS_WITH_EXPERIMENTAL -DNATS_HAS_TLS`. `openssl` library must be install
 * and in the include/link paths.
 *
 * @param opts the pointer to the #natsOptions object.
